package com.wangtianya.aspeed.widget.topbar;
...
public class TopBarView extends LinearLayout {
    ...
    public void init() {
        ...
        addView(llTopBar, new LayoutParams(LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

        tvTitle = llTopBar.findViewById(R.id.tvTitle);

        btnLeft = llTopBar.findViewById(R.id.btnLeft);

        container = llTopBar.findViewById(R.id.llBtnRightContainer);
