...
package com.qjuzi.yaa.other.deprecated.iocV1;
...
public class EventListener implements OnClickListener, OnLongClickListener, OnItemClickListener, OnItemSelectedListener,
    ...
    private static Object invokeItemClickMethod(Object handler, String methodName, Object... params) {
        ...
        try {
            ...
            method = handler.getClass()
                    .getDeclaredMethod(methodName, AdapterView.class, View.class, int.class, long.class);
            if (method != null) {
                if (System.currentTimeMillis() - lastclicktime > 300) {
                    Object result = method.invoke(handler, params);
                    lastclicktime = System.currentTimeMillis();
