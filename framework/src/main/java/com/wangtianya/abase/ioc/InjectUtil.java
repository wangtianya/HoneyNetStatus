...
package com.wangtianya.abase.ioc;
...
import com.wangtianya.abase.ioc.annotation.InjectExtra;
import com.wangtianya.abase.ioc.annotation.InjectResource;
...
public class InjectUtil {
    ...
    private static void getResource(Object obj, Field field, InjectResource resource) {
        Resources res = ABaseContext.getContext().getResources();
        Object value = null;
        if (resource.color() != 0) {
    ...
    public static void indectView(Object obj, Field field, InjectView injectview) {
        ...
        // layout中获取
        if (layout != 0) {
            view = LayoutInflater.from(ABaseContext.getContext().getApplicationContext()).inflate(layout, null);
        } else {
            // 在其他view中的view
