...
public class BindingRecycleViewAdapter<T extends BindingAdapterItemModel>
        extends RecyclerView.Adapter<BindingRecycleViewAdapter.BindingHolder> {

    private LayoutInflater inflater;
    private ObservableArrayList<T> modelList;

    public BindingRecycleViewAdapter(Context context, ObservableArrayList<T> modelList) {
        inflater = LayoutInflater.from(context);
        this.modelList = modelList;
        initNotifyChangeListener();
    }

    public BindingRecycleViewAdapter(Context context, ObservableArrayList<T> modelList, int layoutId, int variableId) {
        inflater = LayoutInflater.from(context);
    ...
    // 数据绑定
    @Override
    public void onBindViewHolder(BindingRecycleViewAdapter.BindingHolder holder, int position) {
