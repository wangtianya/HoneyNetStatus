package com.wangtianya.aspeed.widget.matetrialdialog;
...
/**
 * https://github.com/drakeet/MaterialDialog 1.2.2
 */
public class MaterialDialog {
    ...
    private int mTextSize = ScreenUtil.dip2px(6, ASContext.getContext());
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setTextColor(Color.argb(222, 0, 0, 0));
    ...
    public MaterialDialog setPositiveButtonColor(int colorId) {
        mPositiveButton.setTextColor(colorId);
        return this;
    }
    public MaterialDialog setNegativeButtonColor(int colorId) {
        mNegativeButton.setTextColor(colorId);
        return this;
    }
